...
@section('content')
        ...
        <form action="{{ route('estudios.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="paciente_nombre" class="form-control" readonly>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="doctor_nombre" class="form-control" readonly>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" id="agregarEstudio" class="btn btn-success btn-sm">
                        ...
                        <div class="estudio-item border rounded p-3 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nombre_estudio[]" class="form-control"
                                        placeholder="Ej: Ecografía abdominal" required>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="tipo[]" class="form-control" placeholder="Ecografía">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="number" name="precio_laboratorio[]" class="form-control precio-laboratorio"
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" name="precio_cobrado[]" class="form-control precio-cobrado"
                                        step="0.01" min="0" value="0" required>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control utilidad-detalle" value="Bs. 0.00" readonly>
                                ...
                                <div class="col-md-9 text-end">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm eliminarEstudio">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="alert alert-warning mb-0">
                                ...
                                <h4 id="totalLaboratorio" class="mb-0">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="alert alert-success mb-0">
                                ...
                                <h4 id="totalUtilidad" class="mb-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="monto_pagado_paciente" id="montoPagadoPaciente" class="form-control"
                                step="0.01" min="0" value="{{ old('monto_pagado_paciente', 0) }}" required>

                            <small class="text-muted">
                                Se completa automáticamente con el total cobrado.
                            </small>

                        </div>


                        {{-- MONTO PAGADO LABORATORIO --}}
                        <div class="col-md-6">
                            ...
                            <input type="number" name="monto_pagado_laboratorio" id="montoPagadoLaboratorio"
                                class="form-control" step="0.01" min="0" value="{{ old('monto_pagado_laboratorio', 0) }}"
                                required>

                            <small class="text-muted">
                                Se completa automáticamente con el total del laboratorio.
                            </small>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <a href="{{ route('estudios.index') }}" class="btn btn-secondary">
    ...
    <script>
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | ACTUALIZAR TOTALES CUANDO CAMBIAN LOS PRECIOS
        |--------------------------------------------------------------------------
        */
        ...
        */
        ...
        function actualizarTotales() {
            ...
            */
            ...
            document
                .getElementById('montoPagadoPaciente')
                .value =
                totalCobrado.toFixed(2);


            document
                .getElementById('montoPagadoLaboratorio')
                .value =

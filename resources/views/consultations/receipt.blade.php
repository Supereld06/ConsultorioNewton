...
<head>
    ...
    <title>
        Recibo {{ $consultation->receipt_number }}
    </title>
...
<body>
    ...
    <div class="recibo">
        ...
        <div class="info">
            ...
            {{ $consultation->appointment->fecha->format('d/m/Y') }}
            ...
            {{ $consultation->appointment->patient->ci }}
            ...
            {{ $consultation->appointment->doctor->especialidad }}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="right">
                        ...
                        Bs.
                        {{ number_format($pagoMedico->costo_atencion, 2) }}
        ...
        <div class="mensaje">
            ...
            <strong>
                RECIBIDO POR CONCEPTO DE ATENCIÓN MÉDICA
            </strong>

            <br>

            Este recibo corresponde exclusivamente al pago
            por la atención médica realizada.

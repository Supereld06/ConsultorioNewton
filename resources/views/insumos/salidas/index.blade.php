    ...
    <div class="container">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('insumos.salidas.index') }}">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="buscar" id="buscar" class="form-control"
                                placeholder="Buscar por código, motivo o usuario..." value="{{ request('buscar') }}">
                        </div>
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('insumos.salidas.index') }}" class="btn btn-secondary w-100">
